...
<div class="container">
    <div class="row content-form">
            <form class="form" method="GET" action="/schools">
                <div class="row">
                ...
                <div class="col-xs-12 pull-left">
                    <div class="list-group">
                        <c:forEach items="${schools}" var="s">
                            <a href="/school/${s.schoolId}/reviews" class="list-group-item">${s.name}</a>
                        </c:forEach>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12 text-center">
                    <button class="btn btn-warning" type="button" onclick="window.location.href='/school'">
                        Not found? Do you want to add your school?
                    </button>
                </div>
            </div>
